...
class ResourceActionSet(WorkbenchActionSet):
    ...
    id = "envisage.resource.action_set"
    ...
    tool_bars = [
        ToolBar(
            id="envisage.resource.resource_tool_bar",
    ...
    actions = [
        Action(
            ...
            class_name="envisage.resource.action.new_resource_action:"
            "NewResourceAction"
        ),
        Action(
            path="MenuBar/File/New", group="ContainerGroup",
            class_name="envisage.resource.action.new_folder_action:"
            "NewFolderAction"
        ),
        Action(
            path="MenuBar/File", group="CloseGroup",
            class_name="envisage.resource.action.close_action:"
            "CloseAction"
        ),
        Action(
            path="MenuBar/File", group="CloseGroup",
            class_name="envisage.resource.action.close_all_action:"
            "CloseAllAction"
        ),
        Action(
            path="MenuBar/File", group="SaveGroup",
            class_name="envisage.resource.action.save_action:"
            "SaveAction"
        ),
        Action(
            path="MenuBar/File", group="SaveGroup",
        ...
        Action(
            ...
            class_name="envisage.resource.action.import_action:"
            "ImportAction"
        ),
        Action(
            path="MenuBar/File", group="ImportGroup",
            class_name="envisage.resource.action.export_action:"
            "ExportAction"
        ),
        Action(
            path="MenuBar/File", group="ResourceGroup",
            class_name="envisage.resource.action.refresh_action:"
            "RefreshAction"
        ),
        Action(
            path="MenuBar/File", group="ResourceGroup",
            class_name="envisage.resource.action.properties_action:"
            "PropertiesAction"
        ),
        Action(
            path="MenuBar/Edit", group="ClipboardGroup",
            class_name="envisage.resource.action.copy_action:"
            "CopyAction"
        ),
        Action(
            path="MenuBar/Edit", group="ClipboardGroup",
            class_name="envisage.resource.action.delete_action:"
            "DeleteAction"
        ),
        Action(
            path="MenuBar/Edit", group="ClipboardGroup",
            class_name="envisage.resource.action.move_action:"
            "MoveAction"
        ),
        Action(
            path="MenuBar/Edit", group="ClipboardGroup",
            class_name="envisage.resource.action.rename_action:"
            "RenameAction"
        ),
        Action(
            path="MenuBar/Navigate",
            class_name="envisage.resource.action.up_action:"
            "UpAction"
        ),
        Action(
            path="MenuBar/Navigate",
            class_name="envisage.resource.action.home_action:"
            "HomeAction"
        ),
        Action(
            path="MenuBar/Navigate",
            class_name="envisage.resource.action.location_action:"
            "LocationAction"
        ),
        # Toolbar actions
        Action(
...
class ContextMenuActionSet(WorkbenchActionSet):
    ...
    # The action set"s globally unique identifier:
    id = "envisage.resource.context_menu_action_set"
    ...
    menus = [
        ...
        Menu(
            ...
            class_name="envisage.resource.action.open_with_menu_manager:"
            "OpenWithMenuManager"
        )
    ]
    ...
    actions = [
        Action(
            ...
            id="envisage.resource.new_project_action",
            class_name="envisage.resource.action.new_folder_action:"
            "NewFolderAction"
        ),
        Action(
        ...
        Action(
            ...
            id="envisage.resource.open_action",
            class_name="envisage.resource.action.open_action:"
            "OpenAction"
        ),
        Action(
...
#    aliases = {"Resource": "envisage.resource.context_menu"}
